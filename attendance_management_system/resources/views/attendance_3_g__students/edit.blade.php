...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : 'Attendance 3 G  Student' }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('attendance_3_g__students.attendance_3_g__student.update', $attendance3GStudent->id) }}" id="edit_attendance_3_g__student_form" name="edit_attendance_3_g__student_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
