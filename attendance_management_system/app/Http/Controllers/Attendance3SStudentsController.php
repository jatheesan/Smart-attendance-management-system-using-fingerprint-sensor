...
class Attendance3SStudentsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('attendance_3_s__students.index', compact('attendance3SStudents'));
    }
    ...
    public function show($id)
    {
        ...
        return view('attendance_3_s__students.show', compact('attendance3SStudent'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('attendance_3_s__students.edit', compact('attendance3SStudent','students'));
    }
